...
#    from config import lidar_files, ground_planes_by_file
#    from config import training_file_start, training_file_end
#    from calibs import calib_extrinsics, calib_map
#    
#    training_file_start = 7000
#    training_file_end = 7481
#    
#    for file_idx in xrange(training_file_start, training_file_end):
